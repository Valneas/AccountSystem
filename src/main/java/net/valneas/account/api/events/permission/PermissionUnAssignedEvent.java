...
public class PermissionUnAssignedEvent extends PlayerEvent {
    ...
    public PermissionUnAssignedEvent(Player player, Rank rank, Permission permissionManager, String permission) {
        super(player);
        this.rank = rank;
